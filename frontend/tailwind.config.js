...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Premium Swiss Spa Palette
        premium: {
          // Monochromatic base - Pure, Clean, Timeless
          white: '#FFFFFF',
          'gray-50': '#FAFAFA',
          'gray-100': '#F5F5F5',
          'gray-200': '#EEEEEE',
          ...
          // Accent - Minimal, Sophisticated
          'accent': '#2563EB', // Deep blue - trust, professionalism
          'accent-light': '#3B82F6',
          'accent-dark': '#1E40AF',
      ...
      boxShadow: {
        'premium': '0 1px 3px 0 rgba(0, 0, 0, 0.05)',
