...
export const drugPool: DrugSuggestion[] = [
  ...
  { name: 'Simvastatin', smiles: 'CCC(C)(C)C(=O)O[C@H]1C[C@H](C)C=C2C=C[C@H](C)[C@H](CC[C@@H]3C[C@@H](O)CC(=O)O3)[C@]2(C)C1', year: 1991, class: 'Statin' },
  ...
  { name: 'Diazepam', smiles: 'CN1C(=O)CN=C(c2ccccc2)c2ccccc21', year: 1963, class: 'Benzodiazepine' },
