...
export function MermaidRenderer({ code }: { code: string }) {
    ...
    const handleDownload = useCallback(() => {
        ...
        // Adjust watermark coordinates depending on viewbox/diagram dimensions if needed
        const watermarkNode = `
            <g transform="translate(100%, 100%)">
                <image href="${benchsideLogoB64}" x="-105" y="-18" width="14" height="14" opacity="0.4" />
                <text x="-15" y="-6" text-anchor="end" fill="#888888" opacity="0.6" font-size="12px" font-weight="800" font-family="sans-serif" letter-spacing="2px">BENCHSIDE</text>
            </g>`;
