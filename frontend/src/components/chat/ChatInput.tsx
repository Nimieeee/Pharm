                    ...
                    {showAttachMenu && (
                      <>
                        ...
                        <motion.div
                          ...
                          className="absolute bottom-full left-0 mb-4 w-56 p-2 rounded-2xl bg-white/90 dark:bg-[#1E1E1E]/90 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-2xl z-[50]"
                        >
                          <button
                            type="button"
                    ...
                    {showAttachMenu && (
                      <>
                        ...
                        <motion.div
                          ...
                          animate={{ opacity: 1, scale: 1 }}
                          exit={{ opacity: 0, scale: 0, transition: { duration: 0.2, ease: "backIn" } }}
                          className="absolute bottom-full left-0 mb-2 w-64 p-2 rounded-2xl bg-white/90 dark:bg-[#1E1E1E]/90 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-2xl z-[50]"
                        >
                          <button
                            type="button"
                            onClick={() => { fileInputRef.current?.click(); setShowAttachMenu(false); }}
