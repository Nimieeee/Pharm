...
async def chat_stream(
    ...
    try:
        ...
        # =====================================================================
        # 0. VISION ANALYSIS (Move before other checks to ensure context availability)
        # =====================================================================
        image_context_str = ""
        images = chat_request.metadata.get("images", [])
        if images:
            ...
            print(f"🖼️ Processing {len(images)} images: Analysis + Embedding...")
            image_analyses = []
            ...
            for i, img_url in enumerate(images):
                ...
                # This ensures future queries can retrieve this analysis via RAG
            ...
            # Prepare ephemeral context string for IMMEDIATE use
            if image_analyses:
                image_context_str = "\n\n[SYSTEM: The user uploaded images. Here is the detailed analysis of their content generated by the vision model. Use this information to answer the user's request.]\n\n" + "\n\n".join(image_analyses)
