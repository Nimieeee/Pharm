...
- **Chat API**: Multi-Provider AI Routing (NVIDIA NIM, Groq, Mistral) with health-aware failover and intelligent mode selection
...
| `MISTRAL_API_KEY` | Mistral AI API key (Fallback & Embeddings) | Yes |
| `NVIDIA_API_KEY` | NVIDIA NIM API key (Detailed/Research modes) | Yes |
| `GROQ_API_KEY` | Groq API key (Fast mode) | Yes |
