...
async def verify_rag_e2e():
    try:
        print("\n🔎 Starting Verification: PDF Speed Test")
        print("==================================================")
        ...
        # 2. UPLOAD DOCUMENT
        file_path = "CNS STIMULANTS_PHA 425.pdf"
        ...
        query = "Summarize the key points about CNS stimulants from this document."
        print(f"\n3. Asking AI: '{query}'")
